...
function Home() {
  ...
  const works = [
    ...
    },
    {
      ...
      gitHref: "https://github.com/uwoooj/grocery",
      vHref: "",
    },
    {
      id: 3,
      ...
      gitHref: "https://github.com/uwoooj/ending_game",
      vHref: "",
    },
    {
      id: 4,
      ...
      img: "./selec_logo.png",
      siteHref: "https://uwoooj.github.io/selectoCoffe/0725/main_index.html",
      gitHref: "https://github.com/uwoooj/selectoCoffe",
      vHref: "",
    },
    {
      id: 5,
  ...
  return (
    <div className="wrap">
      ...
      <section className="intro" ref={introSectionRef}>
        ...
        <p>
          무너지지않는 끈기와 개발을 사랑하는 신입 웹 개발자 김유진입니다.
          탄탄한 마크업을 기본으로 효율적인 코드의 CSS, 시선을 이끄는 동적인
          Javascript를 추구하며 React, Vue.js 같은 프레임워크로 다채로운 경험을
          쌓았습니다. 누구에게나 만족스러운 사용자 경험을 제공하는 웹
          프론트엔드를 꿈꾸고있습니다. 발전하는 새로운 기술과 다양한
          프레임워크에 대한 공부도 꾸준히 이어나가도록 노력할것입니다.
        </p>
      </section>
